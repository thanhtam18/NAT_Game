...
//--------------------------------------------------------------------------------
#if(GPIO_BUTTONS == 2)
#define PIN_UP_SELECT 34               
#define PIN_DOWN_A 35                  
#define PIN_LEFT_B 0                  
#define PIN_RIGHT_START 2             
#define PIN_BUS1 32                    // ---[ 330R ]---GND
#define PIN_BUS2 33                    // ---[ 330R ]---GND
#define DIGITAL_BUTTON_DELAY_us 10
#endif
//--------------------------------------------------------------------------------
...
#define PIN_UP     25  //SVN
#define PIN_DOWN   26  //IO35
#define PIN_LEFT   27  //SVP
#define PIN_RIGHT  32  //TDI => Do not install 330R resistor!!!
#define PIN_A      33  //IO2
#define PIN_B      34  //TMS
#define PIN_START  35  //TDO
...
/*  printf("Releasing ESP_BT_MODE_BLE for free memory...");
  ...
  pinMode(PIN_BUS1, INPUT_PULLDOWN);
  pinMode(PIN_BUS2, INPUT_PULLDOWN);
  ...
  pinMode(PIN_UP_SELECT, INPUT_PULLDOWN);
  pinMode(PIN_DOWN_A, INPUT_PULLDOWN);
  pinMode(PIN_RIGHT_START, INPUT_PULLDOWN);
  pinMode(PIN_LEFT_B, INPUT_PULLDOWN);
#endif
#if(GPIO_BUTTONS == 3)
   //Buttons Pins Input Init
